            ...
            if (profile != null && profile.getIsActive() == 1) {
                ...
                if (progress == 100 && (orderHasCourse.getIsComplete() == null || orderHasCourse.getIsComplete().toString().isEmpty() || orderHasCourse.getIsComplete() != 1)) {
                    try {
                        ...
                        if (orderHasCourse.getCourse().getCode().equals("9d93acf7-5543-45fb-9f18-c3e57b5fbe69") || orderHasCourse.getCourse().getCode().equals("0769d057-797d-475c-84ba-c11fd6651c04")) {
                            logo = true;
                        }
